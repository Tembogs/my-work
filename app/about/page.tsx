    ...
    <main className="min-h-screen p-10 flex flex-col md:flex-row items-center gap-10 bg-gray-100">
      ...
      <div className="max-w-xl">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <span className="px-3 py-1 bg-green-500 text-white rounded-full">TypeScript</span>
          <span className="px-3 py-1 bg-purple-500 text-white rounded-full">Tailwind CSS</span>
          <span className="px-3 py-1 bg-yellow-500 text-white rounded-full">React</span>
        </div>
      </div>
